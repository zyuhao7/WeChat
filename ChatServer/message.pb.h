...
class SendChatMsgRsp PROTOBUF_FINAL :
 ...
 public:
  ...
  // string touid = 3;
  void clear_touid();
  const std::string& touid() const;
  void set_touid(const std::string& value);
  void set_touid(std::string&& value);
  void set_touid(const char* value);
  void set_touid(const char* value, size_t size);
  std::string* mutable_touid();
  std::string* release_touid();
  void set_allocated_touid(std::string* touid);
  private:
  const std::string& _internal_touid() const;
  void _internal_set_touid(const std::string& value);
  std::string* _internal_mutable_touid();
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr touid_;
  ::PROTOBUF_NAMESPACE_ID::int32 error_;
  ::PROTOBUF_NAMESPACE_ID::int32 fromuid_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_message_2eproto;
...
inline void SendChatMsgRsp::clear_touid() {
  touid_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& SendChatMsgRsp::touid() const {
  // @@protoc_insertion_point(field_get:message.SendChatMsgRsp.touid)
  return _internal_touid();
}
inline void SendChatMsgRsp::set_touid(const std::string& value) {
  _internal_set_touid(value);
  // @@protoc_insertion_point(field_set:message.SendChatMsgRsp.touid)
}
inline std::string* SendChatMsgRsp::mutable_touid() {
  // @@protoc_insertion_point(field_mutable:message.SendChatMsgRsp.touid)
  return _internal_mutable_touid();
}
inline const std::string& SendChatMsgRsp::_internal_touid() const {
  return touid_.Get();
}
inline void SendChatMsgRsp::_internal_set_touid(const std::string& value) {
  
  touid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void SendChatMsgRsp::set_touid(std::string&& value) {
  
  touid_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:message.SendChatMsgRsp.touid)
}
inline void SendChatMsgRsp::set_touid(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  touid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:message.SendChatMsgRsp.touid)
}
inline void SendChatMsgRsp::set_touid(const char* value,
    size_t size) {
  
  touid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:message.SendChatMsgRsp.touid)
}
inline std::string* SendChatMsgRsp::_internal_mutable_touid() {
  
  return touid_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* SendChatMsgRsp::release_touid() {
  // @@protoc_insertion_point(field_release:message.SendChatMsgRsp.touid)
  return touid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void SendChatMsgRsp::set_allocated_touid(std::string* touid) {
  if (touid != nullptr) {
    
  } else {
    
  }
  touid_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), touid,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:message.SendChatMsgRsp.touid)
}
